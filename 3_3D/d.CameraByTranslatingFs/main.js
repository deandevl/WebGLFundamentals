...
try {
  ...
  // Define initial value for camera angle
  let cameraAngle = 0;
  ...
  function drawScene(){
    ...
    // Camera is placed at the origin [0, 0, radius * 1.5]
    ...
    // Inverting the cameraMatrix provides a transform for
    //   everything else in the scene
    const view_m4 = m4_create();
    m4_invert(view_m4, camera_m4);

    // Compute a view projection/perspective matrix
    //   to transform each F
