...
try {
  ...
  // Specify how to pull position data out
  {
  ...
  // Function was derived in the course as an alternative
  //   to ortho projection.
  function getProjectionMatrix(width, height, depth){
    // In row order
    return m4_fromValues(
      2.0/width, 0, 0, 0,     //row 1
      0,  -2.0/height, 0, 0,  //row 2
      0, 0, 2/depth, 0,       //row 3
      -1, 1, 0, 1             //row 4
    )
  }
